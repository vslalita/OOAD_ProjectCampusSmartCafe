				...
				if(jRadioButton2.isSelected()&&jRadioButton1.isSelected()){
					...
					try{
						...
						if(jRadioButton2.isSelected()){
							if(expenses<user.getRemainingExpenses()){
								action="reduce";
							}
							else{
						...
						if(action.equals("add")||action.equals("reduce")){
							CSCApplicationContext.getUserController().updateExpenses(user,expenses, action);
						}
