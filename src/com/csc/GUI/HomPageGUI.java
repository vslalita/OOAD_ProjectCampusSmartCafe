		...
		jButton2.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(items!=null&&items.size()>0){
					...
					vm.validateAndCreateTransaction(items);
				}
			}
		});

		jLabel6.setText("Daily Calories Remaining:");
		jLabel7.setText("Funds remaining for this Month");
